...
constexpr XMFLOAT4 DUNGEON_WALL_COLOR = {0.22f, 0.36f, 0.54f, 1.0f};
constexpr XMFLOAT4 DUNGEON_GOAL_COLOR = {0.14f, 0.40f, 0.02f, 1.0f};
constexpr XMFLOAT4 DUNGEON_CP_COLOR = {0.68f / 1.5f, 0.54f / 1.5f, 0.16f / 1.5f, 1.0f};

// ---- Enemy ----
constexpr float ENEMY_MOVE_SPEED = 2.5f; // 敵の移動速度
constexpr float ENEMY_CELL_SCALE = 0.8f; // 敵ブロックのスケール
constexpr XMFLOAT4 ENEMY_CELL_COLOR = {0.64f, 0.25f, 0.41f, 1.0f};
...
constexpr XMFLOAT4 PLAYER_CELL_COLOR = {0.17f, 0.49f, 0.60f, 1.0f};
...
constexpr XMFLOAT4 PROJECTILE_CELL_COLOR = {0.66f, 0.39f, 0.14f, 1.0f};
...
// ---- Renerer ----
constexpr XMFLOAT4 RENDERER_FLOOR_COLOR = {0.37f, 0.37f, 0.41f, 1.0f};
constexpr XMFLOAT4 RENDERER_PLAY_BG_COLOR = {0.44f, 0.44f, 0.46f, 1.0f};